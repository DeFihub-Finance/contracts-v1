...
describe.only('StrategyManager#closePosition', () => {
    let account1: Signer
            ...
            it('Then the user receives remaining tokens of all liquidity positions in a strategy', async () => {
                ...
                for (const token of strategyTokens) {
                    try {
                        ...
                        console.log(token, {
                            userAfterz: userTokenBalancesAfter[token],
                            userBefore: userTokenBalancesBefore[token],
                            strategyBefore: strategyTokenBalancesBefore[token],
                        })
